...
<div id="content">
	...
	<div class="box">
		...
		<div class="col-md-9">
				...
				<div class='product'>
				<a href='{{URL::to('/distributor_view_product/'.$crops->Fid)}}'>
    ...
    background-size:     cover;'>
						...
						<div class='text'>
							<h3>
								<a href='{{URL::to('/distributor_view_product/'.$crops->Fid)}}'>{{$crops->Fname}} </a>
							</h3>
							
							<p class='price'>{{$crops->SRate}} BDT</p>
							<p class='buttons'>
								<a href="{{URL::to('/view_product/'.$crops->Fid)}}" class='btn btn-default'>View Details</a>
