...
<div id="content">
	<div class="container">
		...
		<div class="col-md-9">
			<div class="row" id="productmain">
						...
						<div id="mycarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">  <!-- Product-1 image 1 -->
									<center>
										<img class="img-responsive"src="{{asset('images/'.$product_details->Fimage)}}">
									</center>
				...
				<div class="col-sm-6">  <!-- col-sm-6 starts -->
					<div class="box">
						...
						<form action="{{URL::to('distributor_addcart/'.$product_details->Fid)}}" method="post" class="form-horizontal">
							@csrf
							...
							<p class="price"><label>Price:&nbsp</label>{{ $product_details->SRate }}<label>৳</label></p>
			...
			<div class="box" id="details">
				<h4>Product Review</h4><br>
				<form action="{{URL::to('distributor_add_review/'.$product_details->Fid)}}" id="popup" method="post">
					@csrf
					<input type="textarea" class="form-control" name="review" placeholder="Write a Review">

					<button class="btn btn-primary" type="submit" style="margin-left:300px;" name="submit">Review</button>
				</form>
			...
			@foreach ($may_like as $like)
				...
				<div class="center-responsive col-md-3"> <!-- suggested prod 1  -->
					...
					<div class="product same-height">
						<div class="item2">
						<a href='{{URL::to('/distributor_view_product/'.$like->Fid)}}'>
							<img src="{{asset('images/'.$like->Fimage1)}}" class="img-responsive">
						</a>
						
						<div class="text">
                        <label>Name:&nbsp</label><a href='{{URL::to('/distributor_view_product/'.$like->Fid)}}'>{{$like->Fname}}</a>
