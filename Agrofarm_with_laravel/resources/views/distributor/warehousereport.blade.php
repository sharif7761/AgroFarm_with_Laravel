	...
	<div class="box">
		...
		@csrf
			...
			<span class="pull-right">
					...
					<button class="btn btn-default" type="submit" formaction="{{url('/distributor_searchwarehouse')}}" name="submit" value="submit" style="background-color: blue;color: white;">
...
<div class="bg-modal2" >
			<div class="modal-content2">
				...
				<form  id="popup" method="POST" enctype="multipart/form-data">
					...
					<input type="text" style="width: 50%;" name="dWid" id="dWid" placeholder="Warehouse id" readonly>
		...
		<button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/distributor_updatewarehouse')}}"  type="submit" name="update_warehouse"  style="background-color: green; color: white;" >Update Warehouse</button>
		<button class="btn btn-default fa fa-trash" formaction="{{url('/distributor_deletewarehouse')}}" type="submit" name="delete_warehouse" class="fa fa-trash" style="background-color: red;color: white;">Delete Warehouse</button>
				</form>
			...
			<div class="modal-content">
				...
				<form  id="popup1" method="POST" enctype="multipart/form-data">
					...
					<button class="btn btn-default fa fa-plus" formaction="{{url('/distributor_addwarehouse')}}" type="submit" name="add_warehouse" style="background-color:slateblue; color: white;">Add Warehouse</button>
				</form>
