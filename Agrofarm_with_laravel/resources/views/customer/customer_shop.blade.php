...
<div class="col-sm-4 col-sm-6 col-lg-6">   <!-- Product--1 starts -->
		...
		<div class="product">
			...
			<p class="buttons" >
							<a href="{{URL::to('/customer_crops')}}" class="btn btn-primary">
...
<div class="col-sm-4 col-sm-6 col-lg-6">   <!-- Product--1 starts -->
		...
		<div class="product" >
			...
			<p class="buttons">
							<a href="{{URL::to('/customer_fruit')}}" class="btn btn-primary">
							<i class="fa fa-shopping-cart"></i>Shop Now
						</a>
...
<div class="col-sm-4 col-sm-6 col-lg-3">   <!-- Product--1 starts -->
		...
		<div class="product">
			...
			<p class="buttons">
							<a href="{{URL::to('/customer_vegetable')}}" class="btn btn-primary">
							<i class="fa fa-shopping-cart"></i>Shop Now
						</a>
