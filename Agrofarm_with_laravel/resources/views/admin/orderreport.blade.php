            ...
            <form action="" method="post">
                ...
                <div>
                    ...
                    <span class="pull-right">
                        ...
                        <button class="btn btn-default" type="submit" formaction="{{url('/admin_searchorder')}}"
                    ...
                    <table class='table table-bordered table-hover'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-default edition" id="add_item" type="button"
            ...
            <div class="bg-modal2">
                <div class="modal-content2">
                    ...
                    <form id="popup" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="text" style="width: 50%;" name="Order_id" id="Order_id" placeholder="Order id"
                            readonly>
                        <input type="text" style="width: 50%;" name="Cus_id" id="Cus_id" placeholder="Customer id"
                            readonly>
                        <input type="text" style="width: 50%;" name="name" id="name" placeholder="Customer name"
                            readonly>
                        ...
                        <input type="text" style="width: 50%;" name="Quantity" id="Quantity" placeholder="Quantity"
                            readonly>
                        <input type="text" style="width: 50%;" name="Total_price" id="Total_price"
                            placeholder="Total price" readonly>
                        <select name="Status" required style="width: 50%;" id="Status" style="width: 50%;">
                            <option Selected disabled hidden value="Pending">Pending</option>
                            <option value="Approved">Approved</option>
                        </select><br><br>

                        <button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/admin_updateorder')}}"
                            type="submit" name="update_order" style="background-color: green; color: white;">Update
                            Order</button>
                        <button class="btn btn-default fa fa-trash" formaction="{{url('/admin_deleteorder')}}"
                            type="submit" name="delete_order" class="fa fa-trash"
                            style="background-color: red;color: white;">Delete Order</button>
                    </form>
            ...
            <div class="bg-modal">
                <div class="modal-content">
                    ...
                    <form id="popup1" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-plus" formaction="{{url('/admin_addfood')}}" type="submit"
