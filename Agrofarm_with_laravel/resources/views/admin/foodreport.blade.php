            ...
            <form action="" method="post">
                ...
                <div>
                    ...
                    <span class="pull-right">
                        ...
                        <button class="btn btn-default" type="submit" formaction="{{url('/admin_searchfood')}}"
            ...
            <div class="bg-modal2">
                <div class="modal-content2">
                    ...
                    <form id="popup" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/admin_updatefood')}}"
                            type="submit" name="update_food" style="background-color: green; color: white;">Update
                            Food</button>
                        <button class="btn btn-default fa fa-trash" formaction="{{url('/admin_deletefood')}}"
            ...
            <div class="bg-modal">
                <div class="modal-content">
                    ...
                    <form id="popup1" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" style="width: 50%;" requiredv name="description" placeholder="Description">
