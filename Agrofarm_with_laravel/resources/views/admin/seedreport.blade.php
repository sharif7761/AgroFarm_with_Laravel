            ...
            <form action="" method="post">
                ...
                <div>
                    ...
                    <span class="pull-right">
                        ...
                        <button class="btn btn-default" type="submit" formaction="{{url('/admin_searchseed')}}"
            ...
            <div class="bg-modal2">
                <div class="modal-content2">
                    ...
                    <form id="popup" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/admin_updateseed')}}"
                            type="submit" name="update_seed" style="background-color: green; color: white;">Update
                            Seed</button>
                        <button class="btn btn-default fa fa-trash" formaction="{{url('/admin_deleteseed')}}"
                            type="submit" name="delete_seed" class="fa fa-trash"
                            style="background-color: red;color: white;">Delete Seed</button>
                    </form>
            ...
            <div class="bg-modal">
                <div class="modal-content">
                    ...
                    <form id="popup1" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-plus" formaction="{{url('/admin_addseed')}}" type="submit"
                            name="add_seed" style="background-color:slateblue; color: white;">Add Seed</button>
                    </form>
