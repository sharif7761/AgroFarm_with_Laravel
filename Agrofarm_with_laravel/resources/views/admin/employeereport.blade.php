            ...
            <form action="" method="post">
                ...
                <div>
                    ...
                    <span class="pull-right">
                        ...
                        <button class="btn btn-default" type="submit" formaction="{{url('/admin_searchemployee')}}"
            ...
            <div class="bg-modal2">
                <div class="modal-content2">
                    ...
                    <form id="popup" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" style="width: 50%;" name="Eid" id="Eid" placeholder="Eid" readonly>
                        <input type="text" style="width: 50%;" name="FullName" id="FullName" required
                            placeholder="FullName">
                        <input type="text" style="width: 50%;" name="Address" id="Address" required
                            placeholder="Address">
                        <input type="text" style="width: 50%;" name="Phone" id="Phone" required placeholder="Phone">
                        <input type="text" style="width: 50%;" name="Position" id="Position" required
                        ...
                        <button class="btn btn-default fa fa-pencil-square-o"
                            formaction="{{url('/admin_updateemployee')}}" type="submit" name="update_employee"
                            style="background-color: green; color: white;">Update employee</button>
                        <button class="btn btn-default fa fa-trash" formaction="{{url('/admin_deleteemployee')}}"
                            type="submit" name="delete_employee" class="fa fa-trash"
                            style="background-color: red;color: white;">Delete employee</button>
                    </form>
            ...
            <div class="bg-modal">
                <div class="modal-content">
                    ...
                    <form id="popup1" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-plus" formaction="{{url('/admin_addemployee')}}"
                            type="submit" name="add_employee" style="background-color:slateblue; color: white;">Add
                            employee</button>
                    </form>
