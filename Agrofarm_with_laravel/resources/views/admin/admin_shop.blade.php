...
<body>
    ...
    <div class="container" id="content">
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-6 col-lg-6">
                <!-- Product--1 starts -->
                ...
                <div class="product">
                    <div class="pic1" id="pic_2">
                        ...
                        <p class="buttons">
                            <a href="{{URL::to('/admin_crops')}}" class="btn btn-primary">
                                <i class="fa fa-shopping-cart"></i>Shop Now
                            </a>
                            <span>
                                <h3 id="pic1_txt"><b>CROPS</b></h3>
                            </span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-sm-4 col-sm-6 col-lg-6">
                ...
                <div class="product">
                    <div class="pic1" id="pic_3">
                        ...
                        <p class="buttons">
                            <a href="{{URL::to('/admin_fruits')}}" class="btn btn-primary">
                                <i class="fa fa-shopping-cart"></i>Shop Now
                            </a>
                            <span>
                                <h3 id="pic1_txt"><b>FRUITS</b></h3>
                            </span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-sm-4 col-sm-6 col-lg-3">
                <!-- Product--1 starts -->
            </div>
            <div class="col-sm-4 col-sm-6 col-lg-6">
                <!-- Product--1 starts -->
                ...
                <div class="product">
                    <div class="pic1" id="pic_4">
                        ...
                        <p class="buttons">
                            <a href="{{URL::to('/admin_vegetables')}}" class="btn btn-primary">
                                <i class="fa fa-shopping-cart"></i>Shop Now
                            </a>
                            <span>
                                <h3 id="pic1_txt"><b>VEGETABLES</b></h3>
                            </span>
                        </p>
                    </div>
                </div>
