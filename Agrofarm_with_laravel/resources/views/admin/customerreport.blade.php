            ...
            <form action="" method="post">
                ...
                <div>
                    ...
                    <span class="pull-right">
                        ...
                        <button class="btn btn-default" type="submit" formaction="{{url('/admin_searchcustomer')}}"
                ...
                <div class="modal-content2">
                    ...
                    <form id="popup" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-pencil-square-o"
                            formaction="{{url('/admin_updatecustomer')}}" type="submit" name="update_customer"
                            style="background-color: red; color: white;">Update</button>
            ...
            <div class="bg-modal">
                <div class="modal-content">
                    ...
                    <form id="popup1" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-plus" formaction="{{url('/admin_adduser')}}" type="submit"
                            name="add_user" style="background-color:slateblue; color: white;">Add user</button>
                    </form>
