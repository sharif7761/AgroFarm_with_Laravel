...
<div id="content">
	...
	<div class="box">
		...
		<div class="col-md-9">
				...
				<div class='product'>
				<a href="{{URL::to('/owner_view_product/'.$fruits->Fid.'/'.$fruits->Type)}}">
    ...
    background-size:     cover;'>
						...
						<div class='text'>
							<h3>
								<a href="{{URL::to('/owner_view_product/'.$fruits->Fid.'/'.$fruits->Type)}}">{{$fruits->Fname}} </a>
							</h3>
							
							<p class='price'>{{$fruits->SRate}} BDT</p>
							<p class='buttons'>
								<a href="{{URL::to('/owner_view_product/'.$fruits->Fid.'/'.$fruits->Type)}}" class='btn btn-default'>View Details</a>
