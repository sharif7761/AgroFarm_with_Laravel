	...
	<div class="box">
		...
		@csrf
			...
			<span class="pull-right">
					...
					<button class="btn btn-default" type="submit" formaction="{{url('/owner_searchemployee')}}" name="submit" value="submit" style="background-color: blue;color: white;">
...
<div class="bg-modal2" >
		...
		<button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/owner_updateemployee')}}"  type="submit" name="update_employee"  style="background-color: green; color: white;" >Update employee</button>
		<button class="btn btn-default fa fa-trash" formaction="{{url('/owner_deleteemployee')}}" type="submit" name="delete_employee" class="fa fa-trash" style="background-color: red;color: white;">Delete employee</button>
				</form>
			...
			<div class="modal-content">
				...
				<form  id="popup1" method="POST" enctype="multipart/form-data">
					...
					<button class="btn btn-default fa fa-plus" formaction="{{url('/owner_addemployee')}}" type="submit" name="add_employee" style="background-color:slateblue; color: white;">Add employee</button>
				</form>
