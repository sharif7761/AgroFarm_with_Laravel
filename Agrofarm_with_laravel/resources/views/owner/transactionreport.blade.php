            ...
            <div>
                <form action="" method="post">
                    ...
                    <span class="pull-right">
                        ...
                        <button class="btn btn-default" type="submit" formaction="{{url('/owner_searchtransaction')}}"
                ...
                <div class="modal-content2">
                    ...
                    <form id="popup" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-pencil-square-o"
                            formaction="{{url('/owner_updatetransaction')}}" type="submit" name="update_transaction"
                            style="background-color: green; color: white;">Update transaction</button>
                        <button class="btn btn-default fa fa-trash" formaction="{{url('/owner_deletetransaction')}}"
            ...
            <div class="bg-modal">
                <div class="modal-content">
                    ...
                    <form id="popup1" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-default fa fa-plus" formaction="{{url('/owner_addtransaction')}}"
