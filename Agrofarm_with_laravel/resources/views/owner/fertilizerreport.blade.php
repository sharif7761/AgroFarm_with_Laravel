	...
	<div class="box">
		...
		@csrf
			...
			<span class="pull-right">
					...
					<button class="btn btn-default" type="submit" formaction="{{url('/owner_searchfertilizer')}}" name="submit" value="submit" style="background-color: blue;color: white;">
...
<div class="bg-modal2" >
			<div class="modal-content2">
				...
				<form  id="popup" method="POST" enctype="multipart/form-data">
					...
					<input type="text" style="width: 50%;" name="Frid" id="Frid" placeholder="Fertilizer id" readonly>
		...
		<button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/owner_updatefertilizer')}}"  type="submit" name="update_fertilizer"  style="background-color: green; color: white;" >Update Fertilizer</button>
		<button class="btn btn-default fa fa-trash" formaction="{{url('/owner_deletefertilizer')}}" type="submit" name="delete_fertilizer" class="fa fa-trash" style="background-color: red;color: white;">Delete Fertilizer</button>
				</form>
			...
			<div class="modal-content">
				...
				<form  id="popup1" method="POST" enctype="multipart/form-data">
					...
					<button class="btn btn-default fa fa-plus" formaction="{{url('/owner_addfertilizer')}}" type="submit" name="add_fertilizer" style="background-color:slateblue; color: white;">Add Fertilizer</button>
				</form>
