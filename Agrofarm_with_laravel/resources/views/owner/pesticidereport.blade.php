	...
	<div class="box">
		...
		@csrf
			...
			<span class="pull-right">
					...
					<button class="btn btn-default" type="submit" formaction="{{url('/owner_searchpesticide')}}" name="submit" value="submit" style="background-color: blue;color: white;">
...
<div class="bg-modal2" >
		...
		<button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/owner_updatepesticide')}}"  type="submit" name="update_pesticide"  style="background-color: green; color: white;" >Update Pesticide</button>
		<button class="btn btn-default fa fa-trash" formaction="{{url('/owner_deletepesticide')}}" type="submit" name="delete_pesticide" class="fa fa-trash" style="background-color: red;color: white;">Delete Pesticide</button>
				</form>
			...
			<div class="modal-content">
				...
				<form  id="popup1" method="POST" enctype="multipart/form-data">
					...
					@csrf
					<input type="text" style="width: 50%;" required name="pname" required placeholder="Pesticide Name">
					...
					<button class="btn btn-default fa fa-plus" formaction="{{url('/owner_addpesticide')}}" type="submit" name="add_pesticide" style="background-color:slateblue; color: white;">Add Pesticide</button>
				</form>
