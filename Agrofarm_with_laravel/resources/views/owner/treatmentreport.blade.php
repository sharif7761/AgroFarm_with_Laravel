	...
	<div class="box">
		...
		@csrf
			...
			<span class="pull-right">
					...
					<button class="btn btn-default" type="submit" formaction="{{url('/owner_searchtreatment')}}" name="submit" value="submit" style="background-color: blue;color: white;">
...
<div class="bg-modal2" >
			<div class="modal-content2">
				...
				<form  id="popup" method="POST" enctype="multipart/form-data">
					...
					<input type="text" style="width: 50%;" name="Tname" id="Tname" placeholder="Treatment name" required>
					<input type="text" style="width: 50%;" name="Symptom" id="Symptom" placeholder="Symptom" required>
					<input type="text" style="width: 50%;" name="Pname" id="Pname" placeholder="Pesticide name" required>
					<input type="text" style="width: 50%;" name="Frname" id="Frname" placeholder="Fertilizer name" required>
					
					
		<button class="btn btn-default fa fa-pencil-square-o" formaction="{{url('/owner_updatetreatment')}}"  type="submit" name="update_treatment"  style="background-color: green; color: white;" >Update Treatment</button>
		<button class="btn btn-default fa fa-trash" formaction="{{url('/owner_deletetreatment')}}" type="submit" name="delete_treatment" class="fa fa-trash" style="background-color: red;color: white;">Delete Treatment</button>
				</form>
			...
			<div class="modal-content">
				...
				<form  id="popup1" method="POST" enctype="multipart/form-data">
					...
					<button class="btn btn-default fa fa-plus" formaction="{{url('/owner_addtreatment')}}" type="submit" name="add_treatment" style="background-color:slateblue; color: white;">Add Treatment</button>
				</form>
